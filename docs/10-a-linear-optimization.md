...
Let’s get introduced to Farmer Jean, who runs a small farm in a little [valley](https://www.stardewvalley.net/)^[Sprites and the costs/profits of Parsnips and Kale are borrowed from Stardew Valley, and this example is an optimization problem that could actually arise in the game.], who will be with us throughout this chapter.
