...
```{r, echo=F, eval=T, out.width="800px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-1.png")
```
...
knitr::include_graphics("images/optim/optim-plot-2.png")
```
...
```{r, echo=F, eval=T, out.width="500px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-3.png")
```
...
```{r, echo=F, eval=T, out.width="500px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-4.png")
```
...
knitr::include_graphics("images/optim/optim-plot-sa-1.png")
```
...
```{r, echo=F, eval=T, out.width="400px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-sp-1.png")
```
...
```{r, echo=F, eval=T, out.width="400px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-sp-2.png")
```
...
```{r, echo=F, eval=T, out.width="400px", fig.align="center"}
knitr::include_graphics("images/optim/optim-plot-sp-3.png")
```
